...
class RentCommercialDetails extends StatefulWidget {
  final DocumentSnapshot documentSnapshot;
  const RentCommercialDetails({Key? key, required this.documentSnapshot}) : super(key: key);

  @override
  State<RentCommercialDetails> createState() => _RentCommercialDetailsState();
}

class _RentCommercialDetailsState extends State<RentCommercialDetails> {
