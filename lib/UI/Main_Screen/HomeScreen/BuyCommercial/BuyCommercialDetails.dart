...
class BuyCommercialDetails extends StatefulWidget {
  final DocumentSnapshot documentSnapshot;
  const BuyCommercialDetails({Key? key, required this.documentSnapshot}) : super(key: key);

  @override
  State<BuyCommercialDetails> createState() => _BuyCommercialDetailsState();
}

class _BuyCommercialDetailsState extends State<BuyCommercialDetails> {
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                widget.documentSnapshot["Floor-Number"],
                                style: GoogleFonts.zenKurenaido(
                                  fontStyle: FontStyle.normal,
                                  decoration: TextDecoration.none,
                                  fontSize: 18.sp,
