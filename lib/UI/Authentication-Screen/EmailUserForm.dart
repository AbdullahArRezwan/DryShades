...
class EmailUserForm extends StatefulWidget {
  var email;
  EmailUserForm({Key? key, required this.email}) : super(key: key);

  @override
  State<EmailUserForm> createState() => _EmailUserFormState();
}

class _EmailUserFormState extends State<EmailUserForm> {
