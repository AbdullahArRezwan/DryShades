...
class PhoneUserForm extends StatefulWidget {
  var phone;
  PhoneUserForm({Key? key, required this.phone}) : super(key: key);

  @override
  State<PhoneUserForm> createState() => _PhoneUserFormState();
}

class _PhoneUserFormState extends State<PhoneUserForm> {
  ...
  Widget buildNumberField(phone) {
    return Padding(
      ...
      child: TextFormField(
        controller: phoneController = TextEditingController(text: phone),
        onSaved: (value) {
          setState(() {
            phone = value!;
          });
